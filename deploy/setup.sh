...
REPOS=(prograph-vault atp-platform maestro arbiter spec-runner spec-runner-vscode deployer dispatcher steward proctor prograph discovery libretto research-bench github-checker impresario disputatio kapelle ai-orchestrators-workspace robin-runtime)
